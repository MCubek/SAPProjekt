...
Growth, value i blend su tri stila investiranja kojima ćemo se baviti u ovom projektu. Za početak ćemo pojasniti što točno znači pojedini stil investiranja. 
Growth fondovi ulažu u dionice firmi za koje se predpostavlja veliki rast, međutim oni imaju veći izloženost riziku jer imaju veću toleraniciju na rizika i spremni su "parkirati" fond u neke dionice zbog očekivanog rasta u budućnosti.
...
Na temelju t-testova možemo zaključiti sljedeće:
Growth investiranje ima najveći povrat za sve testirane podatke, sljedeći najbolji stil investiranja je blend iako za 10-godišnje povrate na razini signifikantnosti 5% možemo reči da blend i value investiranje imaju jednak povrat.
...
```
Pretpostavke t-testa su zadovoljene, testiranje jednakosti varijance:
```{r fig.height=3.5, fig.width=5, echo=FALSE}
print('Growth Blend 3')
...
```
Na temelju p-vrijednosti danih t-testova zaključujemo sljedeće:

Growth je ostao najbolji stil investiranja kada gledamo sharp ratio fondova, zapravo jedina razlika nasprem testiranja čistih povrata fondova je to što na razini signifikantnosti 1% zaključujemo da je blend i value investiranje jednako za 10-godišnji sharp ratio i 3-godišni sharp ratio.
