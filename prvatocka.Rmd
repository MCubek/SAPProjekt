...
=======
Growth, value i blend su tri stila investiranja kojima ćemo usporediti u ovom projektu.
>>>>>>> Stashed changes
...
fit.multi.1 = lm(fund_return_3years ~ category, mutual_funds[mutual_funds$category %in% categories1,])
summary(fit.multi.1)
>>>>>>> Stashed changes
