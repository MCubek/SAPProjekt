...
Koristimo t test.
```{r}
t.test(mutual_funds_small$success, mutual_funds_large$success, alt = "greater", var.equal = FALSE)
```

Ne možemo reći da su manji uspješniji od velikih fondova.
...
rating_proportions <- c(small_high_ratings,large_high_ratings)
rating_sum <- c(small_collective,large_collective)
prop.test(rating_proportions,rating_sum, alt="greater")
```

Ne odbacujemo H0, da su jednake proporcije visoko rangiranih fondova kod skupljih i jeftinijih fonfova.